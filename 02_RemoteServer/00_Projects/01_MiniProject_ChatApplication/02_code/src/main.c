...
void CA_connect(char *des, int port)
{
    ...
    pthread_create(&client_thread, NULL, CA_ReadHandling, (void *)lsReadingConnection);
...
} /* End of CA_StartServer function */
